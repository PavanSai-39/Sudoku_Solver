...
var SudokuSolver = function (testable) {
  ...
  function solve(boardString) {
    ...
    return recursivelySolve(boardString);
  }
  ...
  function recursivelySolve(boardString) {
    var boardArray = boardString.split("");
    ...
    for (var i = 0; i < possibilities.length; i++) {
      ...
      var solvedBoard = recursivelySolve(boardArray.join(""));
      if (solvedBoard) {
        return solvedBoard;
      }
    }
  ...
  if (testable) {
    solver = { 
      ...
      recursivelySolve: recursivelySolve,
